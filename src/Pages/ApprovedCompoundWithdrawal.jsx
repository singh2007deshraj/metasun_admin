...
function ApprovedCompoundWithdrawal({ url }) {
  console.log({ url });
            ...
            <>
              <div className="mb-3 p-3 d-flex align-items-center justify-content-between flex-wrap bg-white rounded">
                ...
                <div className="d-flex align-items-center gap-3">
                  ...
                  />
                  <Button variant="outlined" onClick={()=>handleSearchByUserId(query)}>Search</Button>
                    ...
                    {loading ? (
                      ...
                      swapData?.map((user, index) => (
                        <tr key={user.userId}>
                          ...
                          <td>
                            $
                            {Number(user?.requestedAmount / 1e18 || 0).toFixed(
                              2
                            )}
                          </td>
                          <td>
                          ...
                          <td>
                            $
                            {Number(user?.deductionAmount / 1e18 || 0).toFixed(
                              2
                            )}
                          </td>
                          <td>
...
export default ApprovedCompoundWithdrawal;
